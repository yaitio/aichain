...
class OpenAIClient(BaseClient):
    """
    HTTP transport client for the OpenAI API.
    ...
    (completions, embeddings, image generation, etc.) belong to the
    ...
    url : str | None, optional
        Override the default base URL (e.g. for Azure OpenAI or a proxy).
    ...
    def list_models(self) -> list[str]:
        ...
        -------
        list[str]
            Model identifier strings, e.g. ``["gpt-4o", "gpt-4o-mini", …]``.
