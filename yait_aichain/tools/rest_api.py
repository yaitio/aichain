...
class RestApiTool(Tool):
    ...
    def run(
        ...
        **kwargs
        ...
        # Only ever speak http(s), and block SSRF targets (private / loopback /
        # metadata IPs) unless AICHAIN_ALLOW_PRIVATE_URLS is set — needed when a
        # REST endpoint is on an internal network.
        assert_safe_url(url)
